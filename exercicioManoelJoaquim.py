...
while True:
    ...
    if produto == 0:
        break
dinheiro = float(input('Informe quanto o cliente pagou:  '))
troco = dinheiro - total
print('Loja tabajara, o total da compra foi de {}, o dinheiro recebido foi de {}, e o troco {}'.format(total,dinheiro,troco))
